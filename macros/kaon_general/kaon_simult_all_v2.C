...
void kaon_simult_all_v2(){
    ...
    TH2F *h1 = new TH2F("h1", "", 8, 0.5, 8.5, 8, 0.5, 8.5); //x-> n of k+, y-> n of k-
    ...
    h1->GetXaxis()->SetBinLabel(1, "1 K0");
    h1->GetXaxis()->SetBinLabel(3, "1 #bar{K}0");
    h1->GetXaxis()->SetBinLabel(5, "1 K+");
    h1->GetXaxis()->SetBinLabel(7, "1 K-");
    h1->GetXaxis()->SetBinLabel(2, "2+ K0");
    h1->GetXaxis()->SetBinLabel(4, "2+ #bar{K}0");
    h1->GetXaxis()->SetBinLabel(6, "2+ K+");
    h1->GetXaxis()->SetBinLabel(8, "2+ K-");

    h1->GetYaxis()->SetBinLabel(1, "1 K0");
    h1->GetYaxis()->SetBinLabel(3, "1 #bar{K}0");
    h1->GetYaxis()->SetBinLabel(5, "1 K+");
    h1->GetYaxis()->SetBinLabel(7, "1 K-");
    h1->GetYaxis()->SetBinLabel(2, "2+ K0");
    h1->GetYaxis()->SetBinLabel(4, "2+ #bar{K}0");
    h1->GetYaxis()->SetBinLabel(6, "2+ K+");
    h1->GetYaxis()->SetBinLabel(8, "2+ K-");
